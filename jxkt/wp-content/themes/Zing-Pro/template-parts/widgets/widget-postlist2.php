<?php
//2和1文章插件
//widget xintheme_postlist2

add_action('widgets_init', function(){register_widget('xintheme_postlist2' );});
class xintheme_postlist2 extends WP_Widget {

	public function __construct() {
		$widget_ops = array( 'description' => '可以选择显示最新文章、随机文章。' );
		parent::__construct('xintheme_postlist2', __('【XinTheme】大图文章展示'), $widget_ops);
	}
    ...
    function widget($args, $instance) {
        ...
        echo xintheme_widget_postlist2($orderby,$limit,$cat);
        echo $after_widget;	
    }
...
function xintheme_widget_postlist2($orderby,$limit,$cat){
?>
	<ul class="widget_SpecialCatBigPicPosts">
		<?php
			$args = array(
			...
			<li>
				<a href="<?php the_permalink(); ?>">
					<img src="<?php echo post_thumbnail(250, 250); ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" class="thumb"></a>
