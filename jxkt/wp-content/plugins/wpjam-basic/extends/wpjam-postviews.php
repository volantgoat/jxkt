...
Version: 1.0
*/
if(did_action('init') && class_exists('WPJAM_Postviews')){
	WPJAM_Postviews::image(get_query_var('p'));
}

add_action('init', function(){
	class WPJAM_Postviews{
		public static function filter_template($template, $module){
			return ($module == 'postviews' && !is_file($template)) ? __FILE__ : $template;
		}
	...
	add_filter('wpjam_template',	['WPJAM_Postviews', 'filter_template'], 10, 2);
