...
class WPJAM_SMTP{
	...
	public function get_setting($name){
		if(!is_null($this->settings)){
			...
			return wpjam_basic_get_setting('smtp_'.$name);
		}
	}
...
$smtp_instance	= WPJAM_SMTP::get_instance();

add_action('phpmailer_init',	[$smtp_instance, 'on_phpmailer_init']);
add_filter('wp_mail_from',		[$smtp_instance, 'filter_wp_mail_from']);
add_filter('wp_mail_from_name',	[$smtp_instance, 'filter_wp_mail_from_name']);
